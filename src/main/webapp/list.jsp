...
<link
	...
	crossorigin="anonymous">
	  <style>
    body {
        background-image: url('img/news6.jpg'); /* 배경 이미지 URL을 여기에 설정 */
        background-size: cover; /* 배경 이미지가 화면을 채우도록 설정 */
        background-position: center; /* 배경 이미지의 위치를 중앙으로 설정 */
        background-attachment: fixed; /* 배경 이미지가 스크롤과 함께 이동하지 않도록 설정 */
    }
    .container {
        padding-top: 50px; /* 위쪽 여백 조정 */
    }
</style>
</head>
<body>
	...
	<div class="container" style="padding-top: 50;">
		...
		<button type="button" class="btn" style="background-color: #6f42c1; color: white;" onclick="location.href='write'">글쓰기</button>
